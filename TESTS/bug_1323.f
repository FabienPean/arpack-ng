...
!
! dsdrv2 program modified to reveal the bug in 'dseupd()':
!
!  * 'implicit none' added
!  * rvec = .false. (don't want the eigenvectors)
!  * computation of the norm residual has been commented out
!  * 5th and 6th original arguments (v and ldv) have been replaced by
!    others (z and ldz)
!  * z is an allocatable array -- it is claimed that it is not referenced
!  * ldz = ldv -- fulfill the requirement that ldz .ge. 1
!
...
!  ...
!  #3  0x428E36 in dger_ at dger.f:199
!  #4  0x4099ED in dseupd_ at dseupd.f:852 (discriminator 4)
!  #5  0x401A71 in dseupd_bug_2 at dseupd_bug_2.f:301
!
! É. Canot -- IRISA/CNRS -- Edouard.Canot@irisa.fr
...
!C               call daxpy(n, -d(j,1), v(1,j), 1, ax, 1)
!C               d(j,2) = dnrm2(n, ax, 1)
