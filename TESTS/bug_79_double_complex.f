...
!
!     The initial vector should be in the range of OP (#79)
!
...
!           %----------------------------------%
!           | res2 should contain the norm of  |
!           | initial vector that is A * resid |
!           %----------------------------------%
            go to 9000
         end if
 9000 continue
!     Compare difference to double precision 0 instead of using
!     bitwise comparison operator .ne.
