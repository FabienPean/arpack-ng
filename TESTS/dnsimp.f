...
!
      intrinsic         abs
!
!     Storage and variables for getting matrix from disk
!
      integer dimA, sizeA
      parameter (dimA = 50)
...
!
      ...
      mneupd = 0
!
!     Read in A matrix from disk, Matrix Market format
!
...
!        %-------------------------------------------%
!
!        change to .true. to invoke bug with latest ARPACK
         rvec = .true.
!
...
!==========================================================================
!
!     matrix vector subroutine for Matrix Market format
!
